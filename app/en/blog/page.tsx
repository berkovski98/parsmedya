...
export const metadata: Metadata = { title: 'Insights | Pars Medya Blog', description: 'Practical insights on software development, digital products, marketing and sustainable business growth.', alternates: localizedAlternates('/en/blog', '/blog', '/en/blog') }

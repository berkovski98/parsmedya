...
export const metadata: Metadata = createPageMetadata({ title: 'Insights | Pars Medya Blog', description: 'Read practical insights on software development, digital products, technology strategy, marketing and sustainable business growth.', canonical: '/en/blog', tr: '/tr/blog', en: '/en/blog', locale: 'en' })

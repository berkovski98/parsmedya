...
export const metadata: Metadata = createPageMetadata({ title: 'Contact Pars Medya | Discuss Your Project', description: 'Contact Pars Medya to discuss a custom software, web development, integration or measurable digital growth opportunity with our team.', canonical: '/en/contact', tr: '/iletisim', en: '/en/contact', locale: 'en' })

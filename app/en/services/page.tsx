...
export const metadata: Metadata = createPageMetadata({ title: 'Software & Digital Services | Pars Medya', description: 'Explore custom software, CRM, ERP, SaaS, system integrations, e-commerce, mobile products and measurable digital growth services.', canonical: '/en/services', tr: '/hizmetler', en: '/en/services', locale: 'en' })

...
export const metadata: Metadata = { title: 'Misyonumuz | Pars Medya', description: "Pars Medya'nın işletmelere özel yazılım, dijital dönüşüm ve sürdürülebilir teknoloji çözümleri sunma misyonunu keşfedin.", alternates: localizedAlternates('/misyonumuz', '/misyonumuz', '/en/mission') }
const paragraphs = [

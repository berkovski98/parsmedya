...
export const metadata: Metadata = createPageMetadata({ title: 'Vizyonumuz | Pars Medya', description: "Pars Medya'nın yazılım, dijital dönüşüm ve global teknoloji çözümlerine yönelik uzun vadeli vizyonunu keşfedin.", canonical: '/tr/vizyonumuz', tr: '/tr/vizyonumuz', en: '/en/vision', locale: 'tr' })
